/**
 * WebsiteUpgradeModal.jsx — same as ProUpgradeModal, website-specific copy.
 */
...
const WebsiteUpgradeModal = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <h3 className="font-headline-md text-headline-md text-on-surface text-center mb-2">
          Unlock Website Controls
        </h3>
        <p className="text-[13px] text-on-surface-variant text-center mb-7">
          Take control of how websites are accessed on your computer.
        </p>
...
export default WebsiteUpgradeModal
