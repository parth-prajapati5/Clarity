/**
 * BlockingUpgradeModal.jsx — uses existing design tokens only.
 */
import Button from '../ui/Button'
import MaterialIcon from '../ui/MaterialIcon'

const FEATURES = [
  'Block apps and websites by schedule',
  'Set daily usage limits',
  'Create custom blocking rules',
  'Integrate with Focus Mode',
  'View blocking analytics',
]

const BlockingUpgradeModal = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <h3 className="font-headline-md text-headline-md text-on-surface text-center mb-2">
          Unlock Blocking Controls
        </h3>
        <p className="text-[13px] text-on-surface-variant text-center mb-7">
          Block distracting apps and websites, set daily limits and schedules.
        </p>
        ...
        <div className="space-y-3">
          ...
          <Button variant="text"
            className="w-full justify-center py-2.5 text-[13px] text-on-surface-variant hover:text-on-surface"
            onClick={onClose}>
            Maybe Later
          </Button>
        </div>
...
export default BlockingUpgradeModal
