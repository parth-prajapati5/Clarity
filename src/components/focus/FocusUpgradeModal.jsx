/**
 * FocusUpgradeModal.jsx
 * Pro upgrade overlay for Focus Mode — uses existing design tokens only.
 */
import Button from '../ui/Button'
import MaterialIcon from '../ui/MaterialIcon'

const FEATURES = [
  'Start unlimited focus sessions',
...
const FocusUpgradeModal = ({ isOpen, onClose }) => {
...
export default FocusUpgradeModal
